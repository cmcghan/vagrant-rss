...
sudo apt-get -y install ros-kinetic-kobuki-msgs
...
# *** solution:
#ROS/crumb/crumb_listener/CMakeLists.txt -- add at line 14 (plus extra carriage returns):
...
# *** solution:
#ROS/roboticsgroup_gazebo_plugins/CMakeLists.txt -- add at line 4 (plus extra carriage returns):
#set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} " -std=c++11")
...
# *** solution:
#ROS/crumb/crumb_listener/src/crumb_listener_gazebo.cpp, line 16 was:
...
# *** solution:
#ROS/roboticsgroup_gazebo_plugins/src/mimic_joint_plugin.cpp, line 142 was:
#    mimic_joint_->SetMaxForce(0,max_effort_);
#line 142 becomes:
